...
\newacronym{mis}{MIS}{Maximal Independent Set}
\newacronym{mwis}{MWIS}{Maximum Weighted Independent Set}
...
\newglossaryentry{model}{name={model},
    description={In reference to the neural network that is being used}}
