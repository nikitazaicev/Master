...
# for g in graphs:
#     print(len(g.x), g.num_nodes)
# exit()

graphs2, lineGraphs, target2 = dl.LoadTrain(limit=10)
print(graphs2[0].num_nodes)
print(graphs2[1].num_nodes)
print(graphs2[2].num_nodes)
print(graphs2[3].num_nodes)
