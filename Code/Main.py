...
#print(f'Nodes in line graph = {lineGraphs[0].num_nodes}')
#print(f'Edges in line graph = {len(lineGraphs[0].edge_index[0])}')
#assert((len(lineGraphs[0].edge_weight)==len(lineGraphs[0].edge_index[0])
#       and len(lineGraphs[0].edge_index[0]==len(lineGraphs[0].edge_attr))))
print("-------------------\n")

val_graphs, val_lineGraphs, val_y = dl.LoadVal(limit=5)
